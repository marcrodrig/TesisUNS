...
@section('content')
    <div class="jumbotron">
		...
		<p class="lead">Tomando tres algoritmos de Machine Learning se desarrollan tres modelos para predecir si una cuenta pública de Twitter puede ser un bot o no. La detección de bots no es una tarea fácil, se utilizan muchas características para tal fin, por lo que el resultado obtenido puede no ser certero.
		<br>Además, se brinda la posibilidad de obtener los puntajes de <a href="{{ route('botometer') }}"><i>Botometer</i></a>.
		</p>
